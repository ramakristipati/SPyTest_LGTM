...
def initialize_topology():
    ...
    print_log(
        ...
        - Trunk Vlan 10 between DUT1,DUT2 and DUT3 and enable RPVST and.\n\
        - Trunk PO-1(DUT1<->DUT2),PO-2(DUT2<->DUT3),and PO-3(DUT1<->DUT3)with 3 links and enable RPVST, UDLD.\n\
...
def udld_module_config():
    '''
    - Configure vlans 10 and 11 and enable RPVST
    - Configure RPVST priority to take fwd path DUT1<->DUT2<->DUT3
    ...
    - Enable RPVST priority to take fwd path DUT1<->DUT2<->DUT3\n\
    - Configure PO and add members\n\
    ...
    ### Enable RPVST global
    utils.exec_all(True,[[pvst.config_spanning_tree, dut, "rpvst", "enable"] for dut in dut_list])
...
def udld_module_unconfig():
    ...
    ### Disable RPVST global
    utils.exec_all(True,[[pvst.config_spanning_tree, dut, "rpvst", "disable"] for dut in dut_list])
...
def start_traffic():
    ...
    ###Start Traffic
    #port_handle_list = [tgn_handle[(dut1, 1)],tgn_handle[(dut1, 2)],tgn_handle[(dut3, 1)],tgn_handle[(dut3, 2)]]
    #tg_h.tg_traffic_control(action="run", port_handle=port_handle_list)
...
def udld_basic_validations():
    ...
    print_log("Display the RPVST states on DUT1,DUT2 and DUT3", "MED")
...
def test_rpvst_udld_normal_aggressive():
    '''
        Verify UDLD with various values of message-time and multipliers in normal mode with RPVST
        Verify UDLD with various values of message-time and multipliers in Aggressive mode with RPVST
        Verify UDLD operation with one end in normal mode and other end in aggressive mode with RPVST
        Verify the RPVST convergence with UDLD with Default values of message-time and multipliers in Aggressive mode
        verify Save and Config reload with normal mode with RPVST
        verify Save and Config reload with Aggressive mode with RPVST
        verify Fast reboot with normal mode with RPVST
        verify Fast reboot with Aggressive mode with RPVST
        verify Cold reboot with normal mode with RPVST
        verify Cold reboot with Aggressive mode with RPVST
        verify UDLD docker restartwith normal mode with RPVST
        verify UDLD docker restart with Aggressive mode with RPVST
    '''
    tc_list = ['FtOpSoSwrpvstudld001', 'FtOpSoSwrpvstudld002','FtOpSoSwrpvstudld003','FtOpSoSwrpvstudld004',\
              'FtOpSoSwrpvstudldConfReload001', 'FtOpSoSwrpvstudldConfReload002',\
              'FtOpSoSwrpvstudldFastReboot001','FtOpSoSwrpvstudldFastReboot002',\
              'FtOpSoSwrpvstudldColdReboot001','FtOpSoSwrpvstudldColdReboot002',\
              'FtOpSoSwrpvstudldDockerRestart001', 'FtOpSoSwrpvstudldDockerRestart002']
    print_log("START of TC:test_pvst_udld_normal_aggressive ==>Sub-Test:Verify UDLD functionality with RPVST\n TCs:<{}>".format(tc_list), "HIGH")
    final_result = True
    tc_result1 = 0
    tc_result2 = 0
    tc_result3 = 0
    ...
    print_log("Configure the Message timer and Multiplier 3 and 9..",'MED')
    ...
    if tc_result1 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudld001", "UDLD_RPVST_Normal_message_and_multiplier_timers_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudld001", "UDLD_RPVST_Normal _message_and_multiplier_timers_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result5 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldConfReload001", "UDLD_RPVST_Normal_Config_Reload_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldConfReload001", "UDLD_RPVST_Normal_Config_Reload_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result7 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldFastReboot001", "UDLD_RPVST_Normal_Fast_Reboot_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldFastReboot001", "UDLD_RPVST_Normal_Fast_Reboot_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result9 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldColdReboot001", "UDLD_RPVST_Normal_Cold_Reboot_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldColdReboot001", "UDLD_RPVST_Normal_Cold_Reboot_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result11 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldDockerRestart001", "UDLD_RPVST_Normal_Docker_Restart_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldDockerRestart001", "UDLD_RPVST_Normal_Docker_Restart_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result2 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudld002", "UDLD_RPVST_Aggressive_message_and_multiplier_timers_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudld002", "UDLD_RPVST_Aggressive_message_and_multiplier_timers_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result6 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldConfReload002", "UDLD_RPVST_Aggressive_Config_Reload_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldConfReload002", "UDLD_RPVST_Aggressive_Config_Reload_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result8 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldFastReboot002", "UDLD_RPVST_Aggressive_Fast_Reboot_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldFastReboot002", "UDLD_RPVST_Aggressive_Fast_Reboot_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result10 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldColdReboot002", "UDLD_RPVST_Aggressive_Cold_Reboot_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldColdReboot002", "UDLD_RPVST_Aggressive_Cold_Reboot_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if verify_traffic():
        ...
        final_result = False
    if tc_result12 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudldDockerRestart002", "UDLD_RPVST_Aggressive_Docker_Restart_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudldDockerRestart002", "UDLD_RPVST_Aggressive_Docker_Restart_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if tc_result3 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudld003", "UDLD_RPVST_Aggressive_and_Normal_mode_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudld003", "UDLD_RPVST_Aggressive_and_Normal_mode_Passed", "test_rpvst_udld_normal_aggressive")

    #######################RPVST Convergence########################################
    print_log("RPVST Path convergence from DUT1->DUT2->DUT3 to DUT1->DUT3->DUT2 when block the UDLD on DUT1->DUT2 ports", "HIGH")
    print_log("Verify that the RPVST Path convergence in direction DUT1->DUT2->DUT3 in Aggressive Mode...",'MED')
    port_list_vlan10 = [vars.D3D1P1]
    port_list_vlan11 = ['PortChannel2']
    if pvst.verify_stp_ports_by_state(dut3, trunk_base_vlan, "DISCARDING", port_list_vlan10):
        print_log("The ports DUT3 to DUT1 in vlan 10 DISCARDING state verification PASSED", "HIGH")
    else:
        print_log("The ports DUT3 to DUT1 in vlan 10 DISCARDING state verification FAILED", "HIGH")
        udld_rstp_convergence_normal_blk_v10_fail += 1
        tc_result4 += 1
        final_result = False

    if pvst.verify_stp_ports_by_state(dut3, trunk_base_vlan+1, "DISCARDING", port_list_vlan11):
        print_log("The ports DUT3 to DUT1 in vlan 11 DISCARDING state verification PASSED", "HIGH")
    else:
        print_log("The ports DUT3 to DUT1 in vlan 11 DISCARDING state verification FAILED", "HIGH")
    ...
    if tc_result4 > 0:
       st.report_tc_fail("FtOpSoSwrpvstudld004", "UDLD_RPVST_Convergence_Failed", "test_rpvst_udld_normal_aggressive")
    else:
       st.report_tc_pass("FtOpSoSwrpvstudld004", "UDLD_RPVST_Convergence_Passed", "test_rpvst_udld_normal_aggressive")
    ...
    if final_result:
        ...
        if udld_rstp_convergence_normal_blk_v10_fail  > 0:
            fail_msg.append('UDLD RPVST Convergence DISCARDING in vlan 10 Failed in Aggressive mode:')
        if udld_rstp_convergence_normal_blk_v11_fail  > 0:
            fail_msg.append('UDLD RPVST Convergence DISCARDING in vlan 11 Failed in Aggressive mode:')
        if udld_rstp_convergence_normal_fwd_v10_fail  > 0:
            fail_msg.append('UDLD RPVST Convergence FORWARDING in vlan 10 Failed in Aggressive mode:')
        if udld_rstp_convergence_normal_fwd_v11_fail  > 0:
            fail_msg.append('UDLD RPVST Convergence FORWARDING in vlan 11 Failed in Aggressive mode:')
