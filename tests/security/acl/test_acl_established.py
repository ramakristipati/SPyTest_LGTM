...
def cleanup_fixture_01(request,acl_est_hooks):
    ...
    acl_obj.delete_acl_table(vars.D1, acl_type=acl_type_tcp, acl_table_name=[rule_name_tcp])
...
def test_acl_tcpflags(cleanup_fixture_01):
    ...
    acl_rule_counters = acl_obj.show_acl_counters(vars.D1, acl_type=acl_type_tcp, acl_table=table_name_tcp)        
    if success:
