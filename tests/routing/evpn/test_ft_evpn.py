...
def test_FtOpSoRoEvpnRouterFt3222_5():
    ...
    if not retry_api(Evpn.verify_bgp_l2vpn_evpn_route, evpn_dict["leaf_node_list"][3], rd='23:23',
...
def test_FtOpSoRoEvpnRouterFt3244_4(Ft32214_fixture):
    ...
    retry_api(Evpn.verify_bgp_l2vpn_evpn_route_type_prefix, evpn_dict["leaf_node_list"][3],
                         evpn_type_5_prefix="[5]:[0]:[96]:["+ipv6_nw[0]+"]",rd=evpn_dict["leaf3"]["l3_vni_ip_list"][0],status_code="*>",
                         next_hop=evpn_dict["leaf3"]["loop_ip_list"][1], retry_count=3, delay=2)
