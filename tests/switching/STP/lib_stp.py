...
def lib_stp_port_actions(vars, stp_ela, stp_protocol):
    ...
    rootguard_con_count1_1 = slog.get_logging_count(partner_dut, severity="INFO",filter_list=["Root Guard interface {} VLAN {} consistent (Timeout)".format(remote_interface, random_vlan)])
    rootguard_con_count1_2 = slog.get_logging_count(partner_dut, severity="INFO",filter_list=["Root Guard interface {}, VLAN {} consistent (Timeout)".format(remote_interface, random_vlan)])
    rootguard_con_count1 = rootguard_con_count1_1+rootguard_con_count1_2
    ...
    rootguard_con_count2_1 = slog.get_logging_count(partner_dut, severity="INFO",filter_list=["Root Guard interface {} VLAN {} consistent (Timeout)".format(remote_interface, random_vlan)])
    rootguard_con_count2_2 = slog.get_logging_count(partner_dut, severity="INFO",filter_list=["Root Guard interface {}, VLAN {} consistent (Timeout)".format(remote_interface, random_vlan)])
    rootguard_con_count2 = rootguard_con_count2_1+rootguard_con_count2_2
