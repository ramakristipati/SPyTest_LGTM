...
def test_ldap_tacacs():
    ...
    st.wait(5,'Added delay to reflect the failthrough mode')
    ...
    st.reboot(dut2)
    st.wait(15,'added delay after cold reboot')
    ...
    st.wait(10,'Added delay after configuring the max ldap servers')
    ...
    display_ldap_servers()
    basic_api.get_dut_date_time(dut1)
    st.wait(40,'Added delay to apply the NSS and PAM details on device')
