...
evpn_dict = {"leaf1" : {"intf_ip_list" : ["13.13.1.1", "13.13.2.1", "13.13.3.1", "13.13.4.1",
                        ...
                        "tenant_mac_l2_colon" : "00:02:33:00:00:0A","mclag_system_mac" : "00:AC:AC:AC:AC:AC"},
             "leaf2" : {"intf_ip_list" : ["14.14.1.1", "14.14.2.1", "14.14.3.1", "14.14.4.1",
                        ...
                        "tenant_v6_ip" : "4001::2","mclag_system_mac" : "00:AC:AC:AC:AC:AC"},
...
def setup_mclag_system_mac():
    dict1 = {'domain_id':tg_dict['mlag_domain_id'], 'mac':evpn_dict["leaf1"]["mclag_system_mac"],
            'config':'add'}
    dict2 = {'domain_id':tg_dict['mlag_domain_id'], 'mac':evpn_dict["leaf2"]["mclag_system_mac"],
            'config':'add'}
    parallel.exec_parallel(True,evpn_dict["leaf_node_list"][0:2],mclag.config_mclag_system_mac,[dict1, dict2])

def cleanup_mclag_system_mac():
    dict1 = {'domain_id':tg_dict['mlag_domain_id'], 'mac':evpn_dict["leaf1"]["mclag_system_mac"],
            'config':'del'}
    dict2 = {'domain_id':tg_dict['mlag_domain_id'], 'mac':evpn_dict["leaf2"]["mclag_system_mac"],
            'config':'del'}
